...
#define BABYSTEPPING
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28 // JHG

  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping  // JHG
