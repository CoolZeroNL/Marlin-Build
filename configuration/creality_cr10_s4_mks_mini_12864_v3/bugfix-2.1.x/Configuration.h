...
#define STRING_CONFIG_H_AUTHOR "(CoolZeroNL, default config)" // Who made the changes.
...
#define Z_MIN_ENDSTOP_INVERTING false       // Set to true to invert the logic of the endstop.   // JHG
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // Set to true to invert the logic of the probe.     // JHG 3d touch

// #define Z_MIN_ENDSTOP_INVERTING true       // Set to true to invert the logic of the endstop.   // JHG
// #define Z_MIN_PROBE_ENDSTOP_INVERTING true // Set to true to invert the logic of the probe.     // JHG NPN-type sensor
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 5, 50 }       // JHG
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 31.5, 0, -0.9 }  // JHG
...
#define INVERT_E0_DIR false   // Stock Creality CR-10 4S
...
#define Y_BED_SIZE 360  // Bed blamps... should be 400
...
//
// #define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER  // JHG - Disbaled CR10 orginal LCD
...
#define NEOPIXEL_LED  // JHG
#if ENABLED(NEOPIXEL_LED)
  #define NEOPIXEL_TYPE             NEO_RGB // NEO_GRBW, NEO_RGBW, NEO_GRB, NEO_RBG, etc.    // JHG
  ...
  #define NEOPIXEL_BKGD_COLOR { 255, 75, 0, 0 }  // R, G, B, W     // JHG - yellow
