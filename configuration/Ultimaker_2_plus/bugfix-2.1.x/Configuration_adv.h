...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_DEFAULT_ON true          // JHG - Set default power-up state on
  #define CASE_LIGHT_DEFAULT_BRIGHTNESS 52    // JHG - 20% - Set default power-up brightness (0-255, requires PWM pin)
