...
#define CUSTOM_MACHINE_NAME "Wanhao/Duplicator 4S"
...
#define HOTEND_OFFSET_X { 0.0, -32.90 }  // (mm) relative X-offset for each nozzle
...
// #define Z_MIN_ENDSTOP_INVERTING false  // Set to true to invert the logic of the endstop.     // JHG - not working
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {  94.139704, 94.139704, 400, 104.40 }       // JHG
...
// WAS ENABLED in default config, WHY ?
