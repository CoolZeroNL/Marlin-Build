...
#define CUSTOM_MENU_MAIN
  ...
  // #define CUSTOM_MENU_MAIN_TITLE "Quick Menu"
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 Command Complete"
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  //#define CUSTOM_MENU_MAIN_SCRIPT_RETURN  // Return to status screen after a script
  ...
  #define MAIN_MENU_ITEM_3_DESC "Cooldown"
  #define MAIN_MENU_ITEM_3_GCODE "M140 S0\nM104 S0\nM106 S0"
