...
#define CUSTOM_MENU_CONFIG
  ...
  #define CUSTOM_MENU_CONFIG_TITLE "Quick Menu"
  #define CUSTOM_MENU_CONFIG_SCRIPT_DONE "M117 Command Complete"
  #define CUSTOM_MENU_CONFIG_SCRIPT_AUDIBLE_FEEDBACK
  //#define CUSTOM_MENU_CONFIG_SCRIPT_RETURN  // Return to status screen after a script

  #define CONFIG_MENU_ITEM_1_DESC "Preheat for " PREHEAT_1_LABEL
  #define CONFIG_MENU_ITEM_1_GCODE "M140 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND)

  #define CONFIG_MENU_ITEM_2_GCODE "Preheat for " PREHEAT_2_LABEL
  #define CONFIG_MENU_ITEM_2_GCODE "M140 S" STRINGIFY(PREHEAT_2_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_2_TEMP_HOTEND)

  #define CONFIG_MENU_ITEM_3_GCODE "Cooldown"
  #define CONFIG_MENU_ITEM_3_GCODE "M140 S0\nM104 S0\nM106 S0"
