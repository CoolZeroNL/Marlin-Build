...
#define HOTEND_OFFSET_X { 0.0, 34.20 } // (mm) relative X-offset for each nozzle
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 96.40, 96.40, 400, 102} //E1&2 96.28 orig
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 20, 35 }
